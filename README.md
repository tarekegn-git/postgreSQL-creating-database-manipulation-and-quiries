...
## 🚀 About This Project
Welcome to my PostgreSQL project! In this project, I will create a database named `merkato_market` which contains four tables such as `products, customers, product_categories
